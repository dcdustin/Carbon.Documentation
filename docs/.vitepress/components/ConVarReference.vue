...
<template>
  <div class="max-w-screen-lg mx-auto px-4 py-8">
    ...
    <p class="mb-8">This section contains a comprehensive list of all prefabs available in the game. Each prefab is listed with its unique ID, components, and file path.</p>
                  ...
                  <td class="whitespace-normal pb-4">
                    <div class="flex flex-col ">
                      <div class="flex flex-wrap items-center ">
                        <a :href="`/Carbon.Documentation/references/prefabs/details?id=${prefab.ID}`" class="flex-shrink-0">
