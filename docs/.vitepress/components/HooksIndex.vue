...
<template>
  <div class="max-w-screen-lg mx-auto px-4 py-8">
    ...
    <p class="mb-8">This section contains a comprehensive list of all hooks available in Carbon. Each hook is listed
      with its name, category, and compatibility information.</p>
        ...
        <div class="overflow-x-auto">
          <div class="inline-block min-w-full">
            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
              <tbody>
              <tr v-for="hook in paginatedHooks" :key="hook.fullName" :id="getSanitizedAnchor(hook.fullName)"
